...
export const userRepository = {
  ...
  async getSolicitacao(userId) {
    return User.findById(userId).populate("solicitacao", "name email imagem");
  },

  // Busca o usuario e preenche a lista de aprovacoes pendentes com nome e email.
  async getAprovacao(userId) {
    return User.findById(userId).populate("aprovacao", "name email imagem");
  },
  ...
  async getFriends(userId) {
    return User.findById(userId).populate("friends", "name email imagem");
  },
};
